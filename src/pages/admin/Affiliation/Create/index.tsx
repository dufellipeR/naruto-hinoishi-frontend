...
interface CreateAffiliationForm {
  icon: string;
  name: string;
  desc: string;
  strength: number;
...
const CreateAffiliation: React.FC = () => {
  ...
  const handleSubmit = useCallback(
    async (data: CreateAffiliationForm) => {
      try {
        ...
        await api.post('/affiliation', data);

        addToast({
          type: 'success',
          title: 'Successfully created affiliation',
        });
