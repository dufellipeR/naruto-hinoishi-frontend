  ...
  const handleSubmit = useCallback(
    async (data: CreateKekkeiForm) => {
      try {
        ...
        await api.post('/kekkei', data);

        addToast({
          type: 'success',
          title: 'Kekkei Genkai criado com sucesso',
        });
