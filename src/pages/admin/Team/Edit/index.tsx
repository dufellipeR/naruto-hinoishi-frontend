...
const EditTeam: React.FC = () => {
  ...
  const [team, setTeam] = useState<TeamForm | undefined>(undefined);
  ...
  const handleSubmit = useCallback(
    async (data: TeamForm) => {
      try {
        ...
        addToast({
          type: 'success',
          title: 'Successfully updated team',
        });
  ...
  return (
    <Container>
      ...
      <Content>
        ...
        <Form ref={formRef} onSubmit={handleSubmit} initialData={team}>
          <div>
